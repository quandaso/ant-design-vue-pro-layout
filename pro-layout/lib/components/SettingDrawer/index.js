...
var getThemeList = function getThemeList(i18nRender) {
  ...
  var themeList = [{
    key: 'light',
    url: '/images/zos/antfincdn/NQ%24zoisaD2/jpRkZQMyYRryryPNtyIC.svg',
    title: i18nRender('app.setting.pagestyle.light')
  }, {
    key: 'dark',
    url: '/images/zos/antfincdn/XwFOFbLkSM/LCkqqYNmvBEbokSDscrm.svg',
  ...
  if (list.find(function (item) {
    ...
    themeList.push({
      ...
      disable: true,
      key: 'realDark',
      url: '/images/zos/antfincdn/hmKaLQvmY2/LCkqqYNmvBEbokSDscrm.svg',
